...
export const Home = () => {
  return (
    ...
    <div className='flex flex-col w-screen'>
      <div className='flex flex-col justify-center items-center h-auto md:h-52 text-slate-200  bg-black/50'>
        <div className='flex flex-col md:flex-row justify-center items-center w-full'>
          <div className='text-center md:text-left'>
            <p className='text-l md:text-2xl lg:text-3xl xl:text-4xl font-serif text-yellow-300'>
              Hello There
            </p>
          </div>
          <div className='mt-4 md:mt-0 md:ml-4'>
            <p className='text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-serif text-yellow-300 animate-marquee'>
              I'm Pranav
            </p>
          </div>
        </div>
      ...
      <div className='flex flex-col justify-center items-center h-auto text-slate-200 p-4 bg-black/50'>
        <p className='text-center text-base md:text-lg lg:text-xl xl:text-2xl max-w-4xl'>
